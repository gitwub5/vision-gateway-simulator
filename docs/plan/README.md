...
`docs/plan/`은 팀과 공유할 수 있는 구현 계획, 검증 계획, 로드맵을 둔다.

## 문서 기준

- 실제 구현 순서와 체크리스트는 `phase*_implementation_plan.md`에 둔다.
...
| `phase1_3_scene_domain_roi_gate_poc_plan.md` | Phase 1.3 scene/domain 조건별 ROI Gate PoC 계획 |
